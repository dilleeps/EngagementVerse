...
export function CallControls({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-center gap-3 border-t border-black/[0.08] bg-white px-4 py-3",
        className
      )}
    >
      {/* Mute / Unmute */}
        ...
        {isMuted ? (
          ...
          >
            ...
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M12 18.75a6 6 0 01-5.845-4.688M8.954 8.955A3 3 0 0012 15a3 3 0 002.046-.804"
            />
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
